...
import { User, Lock, Eye, EyeOff, HelpCircle, ArrowRight, ArrowLeft, BookOpen, GraduationCap, RefreshCw } from "lucide-react";
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <div className="absolute left-3 top-1/2 -translate-y-1/2 bg-blue-50 p-1.5 rounded-lg text-blue-600 group-focus-within:bg-blue-600 group-focus-within:text-white transition-all duration-300">
                                        <User size={18} />
                                    </div>
                                    <input
                                        type="text"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all"
                                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="h-12 w-12 flex items-center justify-center bg-gray-50 border border-gray-200 rounded-xl text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition-all"
                                    title="Refresh Code"
                                >
                                    <RefreshCw size={20} />
                                </button>
                            ...
                            <input
                                ...
                                className="w-full pl-4 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all font-medium"
                                value={captchaInput}
                        ...
                        <div className="flex items-center justify-between pt-2">
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all transform hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2 group"
                            >
                                {loading ? (
