              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">consultantfrp@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600">📞</div>
                  <div>
                    ...
                    <p className="text-slate-600">+91 63048 45834</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600">📍</div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl shadow-blue-900/10 p-8 border border-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 bg-gray-50 p-2 rounded-lg border border-gray-200">
                  <div className="flex items-center gap-2 bg-white px-4 py-2 border border-gray-200 rounded font-mono font-bold text-lg text-slate-700 tracking-widest select-none shadow-sm min-w-[120px] justify-center">
                    {captchaText}
                  </div>
                  <button
                    type="button"
