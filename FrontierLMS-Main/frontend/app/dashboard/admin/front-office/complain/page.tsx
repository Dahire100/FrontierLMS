...
export default function ComplainPage() {
    ...
    const fetchComplaints = async () => {
        setLoading(true)
        try {
            const response = await apiFetch(API_ENDPOINTS.COMPLAINT);
            if (response.ok) {
    ...
    const handleEdit = async (id: string, data: any) => {
        try {
            const response = await apiFetch(`${API_ENDPOINTS.COMPLAINT}/${id}`, {
                method: 'PUT',
                body: JSON.stringify(data)
            });
            if (response.ok) {
    ...
    const confirmDelete = async () => {
        ...
        try {
            const response = await apiFetch(`${API_ENDPOINTS.COMPLAINT}/${deleteConfirm.id}`, {
                method: 'DELETE'
            });
            if (response.ok) {
