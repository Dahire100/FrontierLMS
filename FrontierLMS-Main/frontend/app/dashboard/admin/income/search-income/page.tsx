...
import { Search, Filter, Calendar, Receipt, TrendingUp, Eye } from "lucide-react"
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast({ title: "Info", description: "No records found matching criteria" })
                setResults([])
            }
        } catch (error) {
        ...
        <DashboardLayout title="Income Search">
            <div className="space-y-6 max-w-[1600px] mx-auto pb-10">
                ...
                <ViewIncomeModal
                    ...
                    income={results.find(r => r.id === viewingId)}
                />
            </div>
        </DashboardLayout>
    )
